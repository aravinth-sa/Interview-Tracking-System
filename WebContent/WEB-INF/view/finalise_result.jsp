...
<body>
	...
	<div class="animated bounceInUp container" style="width: 60%;">
		<s:form action="finalise" modelAttribute="interviewScheduleBean"
			method="post">
			<fieldset class="scheduler-border well">
				...
				<div class="form-group">
					<span> <label style="">Result</label>
					</span> <span> <s:select class="form-control" path="result">
							<s:option value="#">select result status</s:option>
							<s:option value="SELECTED">SELECTED</s:option>
